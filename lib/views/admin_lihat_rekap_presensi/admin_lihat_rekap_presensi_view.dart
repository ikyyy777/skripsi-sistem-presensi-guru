                                    ...
                                    trailing: TextButton(
                                      ...
                                      onPressed: () async {
                                        try {
                                          ...
                                          await adminController.exportPresenceDataToExcel(rekapData);
                                        } catch (e) {
                                                    ...
                                                    return AlertDialog(
                                                      ...
                                                      actions: [
                                                        ...
                                                        TextButton(
                                                          onPressed: () {
                                                            if (selectedOption == "Cuti") {
                                                              adminController.postPresenceManual(guru.username, DateTime.now().toString(), "Cuti ${keteranganController.text}");
                                                            }
                                                            else if (selectedOption == "Hadir") {
                                                              adminController.postPresenceManual(guru.username, DateTime.now().toString(), "Hadir");
                                                            }
                                                            Navigator.of(context).pop();
                                                          },
                                                          child: Text(
